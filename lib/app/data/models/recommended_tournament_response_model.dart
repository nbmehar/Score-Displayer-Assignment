...
TournamentListPageModel tournamentListModelFromJson(String str) => TournamentListPageModel.fromJson(json.decode(str));

String tournamentListModelModelToJson(TournamentListPageModel data) => json.encode(data.toJson());

class TournamentListPageModel {
    TournamentListPageModel({
        this.code,
        this.data,
        this.success,
    });
    ...
    factory TournamentListPageModel.fromJson(Map<String, dynamic> json) => TournamentListPageModel(
        code: json["code"],
